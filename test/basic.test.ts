...
suite("Basic test suite", function() {
    ...
    suite("Sub-suite", () => {
        test("Sub-suite test", () => {
            ...
            expect(topLevelSuiteData.parentSuites).to.be.null;
            ...
            expect(topLevelSuiteData.directTestMetrics.totalTime).to.be.null;
            expect(topLevelSuiteData.directTestMetrics.averageTime).to.be.null;
            ...
            expect(recursiveSuiteData.subTestMetrics.totalTime).to.be.null;
            expect(recursiveSuiteData.subTestMetrics.averageTime).to.be.null;
